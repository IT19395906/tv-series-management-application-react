        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('http://localhost:8080/api/tvseries/add', {
                    ...
                    .then(result => {
                        if (result.message == 'Tv Series Uploaded Successfully') {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="file" id="img" name="img" className={`form-control ${touched.img && !formData.img ? 'is-invalid' : ''}`} onChange={handleChange} onBlur={handleBlur} required value={formData.img}
                                    accept="image/*" />
                            </div>
